...
*/
BoundingQuad::BoundingQuad(const glm::vec2& bmin, const glm::vec2& bmax)
	: _min(bmin)
	, _max(bmax)
{
	_update();
...
*/
BoundingQuad::BoundingQuad(const BoundingCircle& circle)
{
...
*/
BoundingQuad::BoundingQuad(const BoundingQuad& q0, const BoundingQuad& q1)
...
*/
BoundingQuad::BoundingQuad(const BoundingQuad& quad)
	: _min(quad._min)
	, _max(quad._max)
...
*  @param [in] box Source bounding quad.
*/
BoundingQuad& BoundingQuad::operator= (const BoundingQuad& quad)
{
	_min    = quad._min;
	_max    = quad._max;
	_center = quad._center;
...
ContainmentType::Value BoundingQuad::contains(const BoundingQuad& quad)
{
...
ContainmentType::Value BoundingQuad::contains(const BoundingCircle& circle)
{
...
*/
ContainmentType::Value BoundingQuad::contains(const glm::vec2& point)
{
...
*/
bool BoundingQuad::intersects(const Ray2d& ray)
{
 ...
 *  @param [in] line Line.
 */
Side BoundingQuad::classify(const Line2d& line) const
{
...
*/
void BoundingQuad::transform(const glm::mat3& m)
{
	glm::vec2 dummy[2] =
	{ 
...
const glm::vec2& BoundingQuad::getMax() const { return _max; }
/** Get quad center. **/
const glm::vec2& BoundingQuad::getCenter() const { return _center; }
/** Get quad extent. **/
const glm::vec2& BoundingQuad::getExtent() const { return _extent; }
